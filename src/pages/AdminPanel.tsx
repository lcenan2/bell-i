  ...
  return (
    <div style={{ 
      ...
      <p style={{ color: '#666', marginBottom: '30px' }}>
        Add new restaurants and menu items to Bell-I
      </p>
      ...
      <form onSubmit={handleSubmit} style={{ 
        ...
        {/* Restaurant Info */}
        <h2 style={{ marginBottom: '20px', fontSize: '20px' }}>Restaurant Information</h2>
        ...
        <div style={{ marginBottom: '20px' }}>
          ...
          <input
            ...
            placeholder="e.g., Mexican, American, Chinese"
            required
            style={{
              width: '100%',
              padding: '10px',
        ...
        <div style={{ marginBottom: '20px' }}>
          ...
          <input
            ...
            placeholder="e.g., Green Street, Campustown"
            required
            style={{
              width: '100%',
              padding: '10px',
        ...
        <div style={{ marginBottom: '30px' }}>
          ...
          <small style={{ color: '#666', fontSize: '12px' }}>
            Tip: Search for the restaurant on Unsplash and copy the image URL
          </small>
        </div>
        ...
        <div style={{ 
          ...
          <h2 style={{ marginBottom: '20px', fontSize: '20px' }}>Menu Items</h2>
          ...
          {menuItems.map((item, index) => (
            ...
            >
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr', gap: '10px', marginBottom: '10px' }}>
                <input
                  type="text"
                  placeholder="Item name (e.g., Burrito Bowl)"
                  value={item.name}
              ...
              <input
                ...
                value={item.photoUrl}
                onChange={(e) => updateMenuItem(index, 'photoUrl', e.target.value)}
                style={{
                  width: '100%',
                  padding: '8px',
                  border: '1px solid #ddd',
        ...
        >
          {loading ? 'Adding Restaurant...' : 'Add Restaurant to Bell-I'}
        </button>
      </form>
    </div>
  );
